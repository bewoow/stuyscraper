...
def main(stuytown_url, email_username, email_password, smtp_server, smtp_port, email_recipients):
    while True:
...
if __name__ == '__main__':
    ...
    main(stuytown_url, email_username, email_password, smtp_server, smtp_port, email_recipients)
